...
// MongoDB setup
mongoose.connect('mongodb+srv://Daniel_Danna:componentes2024@cluster0.qhgbu5m.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', {
...
app.get('/pets', async (req, res) => {
  try {
    ...
    // Encontrar y ordenar los pets
    const petsDB = await Pet.find().sort(sortCriteria);
